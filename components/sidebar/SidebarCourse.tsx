...
import { Book, Rocket, ChevronRight } from 'lucide-react'

const tableOfContents = [
  { title: 'DevOps', slug: 'devops', icon: Book },
  { title: 'Spring', slug: 'spring', icon: Rocket },
]
...
export default function SidebarCourse() {
  ...
  return (
    <aside className="w-64 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 shadow-lg p-6 overflow-auto sticky top-0 h-screen">
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-2">Content</h2>
