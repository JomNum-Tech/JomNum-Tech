...
export const StarIcon = () => (
	<>
		<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="yellow" stroke="yellow" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m12 2l3.09 6.26L22 9.27l-5 4.87l1.18 6.88L12 17.77l-6.18 3.25L7 14.14L2 9.27l6.91-1.01z"/></svg>
	</>
)
...
export const Shapes = () => (
	<>
		...
		<div className="absolute -top-[15%] -right-[15%] w-[600px] h-[600px] rounded-full bg-slate-100 dark:bg-slate-800 -z-20" />
	</>
);

export const ShapeSeven = () => (
	<svg
